                                    ...
                                    {navigation.categories.map((category) => (
                                        <Popover key={category.name} className="flex">
                                            <div className="relative flex">
                                                <PopoverButton className="relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px text-m font-medium text-gray-600 transition-colors duration-200 ease-out hover:text-gray-800 data-[open]:border-emerald-600 data-[open]:text-emerald-600">
                                                    {category.name}
                                                </PopoverButton>
                                            </div>
